...
SELECT assert(count(*) = 0, 'empty observation_history_tag') FROM observation_history_tag where resource_id = :'uuid';
...
SELECT assert(count(*) = 0, 'insert: empty tags history') FROM observation_history_tag where resource_id = :'uuid';
...
SELECT assert(count(*)=2,'update: 2 tags in history') FROM observation_history_tag where resource_id = :'uuid';
...
SELECT assert(count(*)=5,'delete: 5 in history tags') FROM observation_history_tag where resource_id = :'uuid';
