...
index_primitive_as_token('{"a":[{"b":1},{"b":2}]}','{a,b}') => '{1,2}'::varchar[]

index_primitive_as_token(getv('obs'),'{status}') => '{final}'::varchar[]
...
expect
  index_as_reference(getv('pt-ref'),'{managingOrganization}'::varchar[])
=> '{Organization/1,1}'
